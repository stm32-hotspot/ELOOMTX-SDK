...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
extern PCD_HandleTypeDef            hpcd_USB_OTG_FS; //TODO: STF - Workshop: maybe a parameter in a MX structure.
...
{
  MX_USB_OTG_FS_PCD_Init(); //TODO: STF - Workshop: maybe a parameter in a MX structure.

  //TODO: STF - used for NUCLEO-U5
...
//  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 2, 0x20);
  ...
  _ux_dcd_stm32_initialize((ULONG)USB_OTG_FS, (ULONG)&hpcd_USB_OTG_FS); //TODO: STF - Workshop: maybe a parameter in a MX structure.
}
